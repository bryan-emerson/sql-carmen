...
SELECT * FROM countrylangauges WHERE countrycode = 'VAT';
...
SELECT * FROM cities JOIN countries ON countries.capital = cities.id WHERE countries.capital = 211;
...
carmen=# SELECT name FROM cities WHERE population = 91084;
